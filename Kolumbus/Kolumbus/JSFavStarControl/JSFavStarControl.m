...
- (id)initWithLocation:(CGPoint)location dotImage:(UIImage *)dotImage starImage:(UIImage *)starImage rating:(NSInteger)rating
{
	if (self = [self initWithFrame:CGRectMake(location.x, location.y, 100, 25)])
	{
		_rating = rating;
